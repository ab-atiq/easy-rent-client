        ...
        <Container sx={{ marginX: "auto" }}>
            ...
            <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
                ...
                <AccordionDetails>
                    <Typography>
                        <ol type="i">
                            <li>Save time. Getting around with a car is faster than public transport. </li>
                            <li>Discover more. Travelers are limited when traveling around with public transport.  </li>
